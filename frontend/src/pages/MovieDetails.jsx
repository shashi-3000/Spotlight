...
// import oscarBg from "../assets/img.jpg"
// import MovieCarousel from "../components/movies/MovieCarousel.jsx"
// import { tmdbAPI, GENRE_IDS } from "../services/tmdb.js";
...
//         const [trending, topRated, action, drama] = await Promise.all([
//           tmdbAPI.getTrending(),
//           tmdbAPI.getTopRated(),
...
//   if (loading) {
//     return (
//       <div className="min-h-screen flex items-center justify-center text-white pt-28">
