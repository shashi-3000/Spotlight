...
//       <button
//         onClick={() => scroll("left")}
//         className="absolute left-0 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-black/80 text-yellow-400 p-2 rounded-full z-10"
//       >
//         <ChevronLeft size={28} />
//       </button>
...
//         className="absolute right-0 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-black/80 text-yellow-400 p-2 rounded-full z-10"
//       >
